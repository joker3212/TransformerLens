...
from transformer_lens import HookedSSMConfig
...
class HookedSSM(HookedRootModule):
    """Hooked SSM.
    ...
    def __init__(
        self,
        cfg: Union[HookedSSMConfig, Dict],
        ...
        if isinstance(cfg, Dict):
            cfg = HookedSSMConfig(**cfg)
        elif isinstance(cfg, str):
            raise ValueError(
                "Please pass in a config dictionary or HookedSSMConfig object. If you want to load a "
                "pretrained model, use HookedSSM.from_pretrained() instead."
            )
        self.cfg = cfg
